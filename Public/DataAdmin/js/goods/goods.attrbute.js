$(function(){
    ...
    $("#addAttr,#addImgAttr").click(function(){
            ...
            html += '<a class="btn btn-xs btn-danger pull-right delAttr" style="margin-right:50px;">删除属性</a>';
            ...
            if($(this).hasClass("addImgAttr")){
                ...
                html += '</p>';
                html += '<i class="fa fa-close delAttrVal">X</i>';
                html += '</div>';
            }else{
                html += '<div class="attrs_item" index=0>';
                html += '<p>';
    ...
    $("#create_stock_table").click(function(){
        ...
        var i=0;
        var attrNum = $("#attribute tr").length;
        //生成规格数据
        $("#attribute tr").each(function(v){
            i++;
            var temp = Array();
